		...
		<ul class="rd-navbar-nav">
			...
			<li><a href="#">¿D&oacute;nde ir?</a>
				...
				<ul class="rd-navbar-dropdown">
					...
					?>
					<li>
						<a href="http://<?php echo $category['url']; ?>/"><?php echo $category['name']; ?></a>
					</li>
					<?php
					}
					?>
			...
			<li><a href="/eventos.wheretogo.com.mx/">Eventos</a></li>
    ...
    public function getCategoriesFooter()
    {
    	...
    	if($this->data['categories'])
    	{
    		foreach ($this->data['categories'] as $category)
    		{
    			?>
    		<li>
    		    <a href="http://<?php echo $category['url']; ?>/" class="text-bermuda">
...
//                     var_dump($this->data);
    ...
    public function getIndexContent()
    {
        ...
        <div data-speed="0.2" data-type="media" data-url="<?php echo $this->data['appInfo']['url']; ?>/media/categories/banners/<?php echo $this->data['categoryInfo']['banner']; ?>" class="rd-parallax-layer"></div>
        <div data-speed="0" data-type="html" class="rd-parallax-layer">
          <div class="bg-overlay-darker">
            <div class="shell-wide section-34 section-md-60 section-lg-top-130 section-lg-bottom-155">
              <div class="veil reveal-md-block">
                <h1><?php echo $this->data['categoryInfo']['name']; ?></h1>
              </div>
            </div>
          </div>
        </div>
        ...
        <section>
          <div class="shell-wide">
            <h3><?php echo $this->data['categoryInfo']['description']; ?></h3>
            <div class="range range-xs-center offset-top-50 offset-lg-top-85">
              <div class="cell-xl-10 cell-xl-preffix-1">
                <div class="isotope-wrap isotope-wrap-vertical-border-left isotope-offset-30">
                  <div class="row">
                        ...
                        <div class="isotope-filters isotope-filters-vertical">
                          <ul class="list-inline list-inline-sm reveal-md-block inset-sm-left-15 inset-sm-right-15">
                            ...
                            <li class="section-relative offset-top-20 offset-xs-top-0 reveal-block reveal-xs-inline-block reveal-md-block">
                              <button data-custom-toggle="isotope-1" data-custom-toggle-disable-on-blur="true" class="isotope-filters-toggle btn btn-primary-outline">Filter
                                  <span class="caret"></span>
                                </button>
                              <ul id="isotope-1" class="list-sm-inline isotope-filters-list reveal-md-block">
                                <li><a data-isotope-filter="*" data-isotope-group="gallery" href="food.html#" class="active">Todas las <span class="veil reveal-md-inline-block">Categorias</span></a></li>
                                <?php 
                                foreach ($this->data['subcategories'] as $subcategory)
                                {
                                	?>
                                	<li><a data-isotope-filter="<?php echo $subcategory['name']; ?>" data-isotope-group="gallery" href="#"><?php echo $subcategory['name']; ?></a></li>
                                	<?php
                                }
                                ?>
                              </ul>
                    ...
                    <!-- Isotope Content-->
                    <div class="col-lg-9 col-xl-10 offset-top-90 offset-lg-top-65">
                ...
                <div class="range range-condensed range-xs-center">
					<div class="cell-xs-6 cell-sm-6 cell-lg-2 inset-left-15 inset-right-15 inset-md-left-0 inset-md-right-0">
                        ...
                        <figure class="thumbnail-terry thumbnail-terry-modern">
                            <a href="food.html">
                                <img width="480" height="360" src="/images/atracciones.jpg" alt="Restaurantes Playa del Carmen">
                            </a>
                    ...
                    <div class="cell-xs-6 cell-sm-6 cell-lg-2 inset-left-15 inset-right-15 inset-md-left-0 inset-md-right-0">
                        ...
                        <figure class="thumbnail-terry thumbnail-terry-modern">
                            <a href="food.html">
                                <img width="480" height="360" src="/images/comida_y_bebida.jpg" alt="Restaurantes Playa del Carmen">
                            </a>
                            <figcaption class="text-left">
                                <div class="figcaption-caption">
                    ...
                    <div class="cell-xs-6 cell-sm-6 cell-lg-2 inset-left-15 inset-right-15 inset-md-left-0 inset-md-right-0">
                        ...
                        <figure class="thumbnail-terry thumbnail-terry-modern">
                            <a href="food.html">
                                <img width="480" height="360" src="/images/hospedaje.jpg" alt="Restaurantes Playa del Carmen">
                            </a>
                            <figcaption class="text-left">
                                <div class="figcaption-caption">
                    ...
                    <div class="cell-xs-6 cell-sm-6 cell-lg-2 offset-top-40 offset-xs-top-0 inset-left-15 inset-right-15 inset-md-left-0 inset-md-right-0">
                        ...
                        <figure class="thumbnail-terry thumbnail-terry-modern">
                            <a href="atracciones-tours.html">
                                <img width="480" height="360" src="/images/lugares_publicos.jpg" alt="Atracciones Playa del Carmen">
                            </a>
                            <figcaption class="text-left">
                                <div class="figcaption-caption">
